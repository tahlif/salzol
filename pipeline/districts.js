...
const AMBIGUOUS = new Set(['אזור', 'גנים', 'כרמל', 'נווה', 'שפירא', 'אדם', 'עלי', 'שילה', 'מגן', 'שדה', 'ניר', 'גן', 'רם', 'טל אל', 'יעד', 'שער אפרים', 'בת חן', 'חצב', 'ברקן', 'מישר', 'דור', 'רגבה', 'בצת', 'ספיר', 'ברכה', 'שמשית', 'להב', 'ארבל', 'שחר', 'נטע', 'אשל']);
